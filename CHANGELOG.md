...
## [0.1.0-alpha.4] - 2026-01-10

### Changed

- Simplified asset loading: module assets are now auto-registered when module loads
- Model paths use simple relative paths (e.g., `pose.model("models/movenet/singlepose-lightning.onnx")`)
- Removed `ensureAssetsRegistered()` boilerplate from ONNXModel
